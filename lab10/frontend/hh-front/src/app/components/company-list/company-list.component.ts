...
@Component({
  ...
  template: `
    <div class="mb-8">
      <h1 class="text-3xl font-bold mb-6 text-pink-900">Companies</h1>
      <a routerLink="/companies/new" class="bg-pink-200 text-pink-900 px-4 py-2 rounded hover:bg-pink-400">
        Add New Company
      </a>
    </div>
